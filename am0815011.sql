...
CREATE TABLE `basket_made` (
  ...
  `qyjj` text,
  `fddbxm` text COMMENT '姓名',
  `fddbxb` text COMMENT '性别',
  `fddbzgxl` text COMMENT '最高学历',
  `fddbzw` text COMMENT '职务',
  `fddbzc` text COMMENT '职称',
  `fddbzy` text COMMENT '专业',
  `fddbgddh` text COMMENT '固定电话',
  `fddbyddh` text COMMENT '移动电话',
  `fddbzypx` text COMMENT '参加过何种专业或安全生产培训',
  `fddbpxsj` text COMMENT '培训时间',
  `fddbzsbh` text COMMENT '培训合格证书编号',
  `jsfzrxm` text,
  `jsfzrxb` text,
  `jsfzrzgxl` text,
  `jsfzrzw` text,
  ...
  `jsfzrpxsj` text,
  `jsfzrzsbh` text,
  `zlfzrxm` text COMMENT '姓名',
  `zlfzrxb` text COMMENT '性别',
  `zlfzrzgxl` text COMMENT '最高学历',
  `zlfzrzw` text COMMENT '职务',
  `zlfzrzc` text COMMENT '职称',
  `zlfzrzy` text COMMENT '专业',
  `zlfzrgddh` text COMMENT '固定电话',
  `zlfzryddh` text COMMENT '移动电话',
  `zlfzrzypx` text COMMENT '参加过何种专业或安全生产培训',
  `zlfzrpxsj` text COMMENT '培训时间',
  `zlfzrzsbh` text COMMENT '培训合格证书编号',
