...
namespace SMSW.Helper
{
    public class ValidationHelper
    {
        ...
        #region 验证生日 1987-02-05
        public static bool IsBirthday(string source)
        {
            return Regex.IsMatch(source, @"^(\d){4}-(\d){2}-(\d){2}$", RegexOptions.IgnoreCase);
        }
        #endregion
        ...
        public static bool IsPositiveIntegerContainsZero(string source)
        {
            return Regex.IsMatch(source, @"^[0-9]\d*$", RegexOptions.IgnoreCase);
        }
        #endregion
        ...
        {
            return Regex.IsMatch(source, @"(^[1-9]\d*\.\d*$)|(^0\.\d*[1-9]\d*$)|(^[1-9]\d*$)|(^0$)|(^0\.0+$)", RegexOptions.IgnoreCase);
        }
        #endregion
        ...
        public static bool IsGUID(string source)
        {
            if (source != null)
            {
                return Regex.IsMatch(source, @"^[A-F0-9]{8}(-[A-F0-9]{4}){3}-[A-F0-9]{12}$", RegexOptions.IgnoreCase);
            }
            return false;
        }
