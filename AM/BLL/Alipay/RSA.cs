...
namespace Com.Alipay
{
    ...
    public sealed class RSAFromPkcs8
    {
        ...
        /// <param name="input_charset">编码格式</param>
        /// <returns></returns>
        public static bool verify(string content, string signedString, string publicKey, string input_charset, bool isDebug = false)
        {
            bool result = false;
            ...
            //        if (isDebug == true)
            //        {
            //            isgbk = verify(content, signedString, publicKey, "gbk", true);
            //            isutf8 = verify(content, signedString, publicKey, "utf-8", true);
            //        }
            //        var log = AM.BLL.DB.log;
            //        if (log.IsInfoEnabled)
            //        {
            //            string msg = string.Format("支付验证提示：code={0},gbk={1},utf8={2},Data={3},data={4},content={5},signedString={6},publicKey={7}", code, isgbk, isutf8, Data, data, content, signedString, publicKey);
            //            log.Info(msg);
            //        }
            //    }
            //    catch { }
