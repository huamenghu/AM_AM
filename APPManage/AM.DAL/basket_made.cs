	...
	public partial class basket_madeDAL
	{
        ...
        public bool Add(basket_made model)
        {
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("@qyjj", MySqlDbType.Text),
					...
					new MySqlParameter("@jsfzrxm", MySqlDbType.Text),
					new MySqlParameter("@jsfzrxb", MySqlDbType.Text),
					new MySqlParameter("@jsfzrzgxl", MySqlDbType.Text),
					new MySqlParameter("@jsfzrzw", MySqlDbType.Text),
					new MySqlParameter("@jsfzrzc", MySqlDbType.Text),
					new MySqlParameter("@jsfzrzy", MySqlDbType.Text),
					new MySqlParameter("@jsfzrgddh", MySqlDbType.Text),
					new MySqlParameter("@jsfzryddh", MySqlDbType.Text),
					new MySqlParameter("@jsfzrzypx", MySqlDbType.Text),
					new MySqlParameter("@jsfzrpxsj", MySqlDbType.Text),
					new MySqlParameter("@jsfzrzsbh", MySqlDbType.Text),
            ...
            parameters[19].Value = model.qyjj;
            parameters[20].Value = model.fddbxm;
            parameters[21].Value = model.fddbxb;
            parameters[22].Value = model.fddbzgxl;
            parameters[23].Value = model.fddbzw;
            parameters[24].Value = model.fddbzc;
            parameters[25].Value = model.fddbzy;
            parameters[26].Value = model.fddbgddh;
            parameters[27].Value = model.fddbyddh;
            parameters[28].Value = model.fddbzypx;
            parameters[29].Value = model.fddbpxsj;
            parameters[30].Value = model.fddbzsbh;
            parameters[31].Value = model.jsfzrxm;
            parameters[32].Value = model.jsfzrxb;
            parameters[33].Value = model.jsfzrzgxl;
            parameters[34].Value = model.jsfzrzw;
            parameters[35].Value = model.jsfzrzc;
            parameters[36].Value = model.jsfzrzy;
            parameters[37].Value = model.jsfzrgddh;
            parameters[38].Value = model.jsfzryddh;
            parameters[39].Value = model.jsfzrzypx;
            parameters[40].Value = model.jsfzrpxsj;
            parameters[41].Value = model.jsfzrzsbh;
            parameters[42].Value = model.zlfzrxm;
            parameters[43].Value = model.zlfzrxb;
            parameters[44].Value = model.zlfzrzgxl;
            parameters[45].Value = model.zlfzrzw;
            parameters[46].Value = model.zlfzrzc;
            parameters[47].Value = model.zlfzrzy;
            parameters[48].Value = model.zlfzrgddh;
            parameters[49].Value = model.zlfzryddh;
            parameters[50].Value = model.zlfzrzypx;
            parameters[51].Value = model.zlfzrpxsj;
            parameters[52].Value = model.zlfzrzsbh;
            parameters[53].Value = model.gzryxh1;
            parameters[54].Value = model.gzryxm1;
            parameters[55].Value = model.gzryzw1;
            parameters[56].Value = model.gzryzc1;
            parameters[57].Value = model.gzryfzjg1;
            parameters[58].Value = model.gzryxl1;
            parameters[59].Value = model.gzryzy1;
            parameters[60].Value = model.gzryxh2;
            parameters[61].Value = model.gzryxm2;
            parameters[62].Value = model.gzryzw2;
            parameters[63].Value = model.gzryzc2;
            parameters[64].Value = model.gzryfzjg2;
            parameters[65].Value = model.gzryxl2;
            parameters[66].Value = model.gzryzy2;
            parameters[67].Value = model.gzryxh3;
            parameters[68].Value = model.gzryxm3;
            parameters[69].Value = model.gzryzw3;
            parameters[70].Value = model.gzryzc3;
            parameters[71].Value = model.gzryfzjg3;
            parameters[72].Value = model.gzryxl3;
            parameters[73].Value = model.gzryzy3;
            parameters[74].Value = model.gzryxh4;
            parameters[75].Value = model.gzryxm4;
            parameters[76].Value = model.gzryzw4;
            parameters[77].Value = model.gzryzc4;
            parameters[78].Value = model.gzryfzjg4;
            parameters[79].Value = model.gzryxl4;
            parameters[80].Value = model.gzryzy4;
            parameters[81].Value = model.gzryxh5;
            parameters[82].Value = model.gzryxm5;
            parameters[83].Value = model.gzryzw5;
            parameters[84].Value = model.gzryzc5;
            parameters[85].Value = model.gzryfzjg5;
            parameters[86].Value = model.gzryxl5;
            parameters[87].Value = model.gzryzy5;
            parameters[88].Value = model.tzzyryxh1;
            parameters[89].Value = model.tzzyryxm1;
            parameters[90].Value = model.tzzyrygz1;
            parameters[91].Value = model.tzzyryxh2;
            parameters[92].Value = model.tzzyryxm2;
            parameters[93].Value = model.tzzyrygz2;
            parameters[94].Value = model.tzzyryxh3;
            parameters[95].Value = model.tzzyryxm3;
            parameters[96].Value = model.tzzyrygz3;
            parameters[97].Value = model.tzzyryxh4;
            parameters[98].Value = model.tzzyryxm4;
            parameters[99].Value = model.tzzyrygz4;
            parameters[100].Value = model.tzzyryxh5;
            parameters[101].Value = model.tzzyryxm5;
            parameters[102].Value = model.tzzyrygz5;
            parameters[103].Value = model.zgzsfzjg1;
            parameters[104].Value = model.zgzszsbh1;
            parameters[105].Value = model.zgzsyxq1;
            parameters[106].Value = model.zgzsfzjg2;
            parameters[107].Value = model.zgzszsbh2;
            parameters[108].Value = model.zgzsyxq2;
            parameters[109].Value = model.zgzsfzjg3;
            parameters[110].Value = model.zgzszsbh3;
            parameters[111].Value = model.zgzsyxq3;
            parameters[112].Value = model.zgzsfzjg4;
            parameters[113].Value = model.zgzszsbh4;
            parameters[114].Value = model.zgzsyxq4;
            parameters[115].Value = model.zgzsfzjg5;
            parameters[116].Value = model.zgzszsbh5;
            parameters[117].Value = model.zgzsyxq5;
            parameters[118].Value = model.mxxh1;
            parameters[119].Value = model.mxsbmc1;
            parameters[120].Value = model.mxgg1;
            parameters[121].Value = model.mxsl1;
            parameters[122].Value = model.mxzzs1;
            parameters[123].Value = model.mxxh2;
            parameters[124].Value = model.mxsbmc2;
            parameters[125].Value = model.mxgg2;
            parameters[126].Value = model.mxsl2;
            parameters[127].Value = model.mxzzs2;
            parameters[128].Value = model.mxxh3;
            parameters[129].Value = model.mxsbmc3;
            parameters[130].Value = model.mxgg3;
            parameters[131].Value = model.mxsl3;
            parameters[132].Value = model.mxzzs3;
            parameters[133].Value = model.mxxh4;
            parameters[134].Value = model.mxsbmc4;
            parameters[135].Value = model.mxgg4;
            parameters[136].Value = model.mxsl4;
            parameters[137].Value = model.mxzzs4;
            parameters[138].Value = model.mxxh5;
            parameters[139].Value = model.mxsbmc5;
            parameters[140].Value = model.mxgg5;
            parameters[141].Value = model.mxsl5;
            parameters[142].Value = model.mxzzs5;
            parameters[143].Value = model.jyylmxxh1;
            parameters[144].Value = model.jyylmxmc1;
            parameters[145].Value = model.jyylmxgg1;
            parameters[146].Value = model.jyylmxsl1;
            parameters[147].Value = model.jyylmxyxq1;
            parameters[148].Value = model.jyylmxxh2;
            parameters[149].Value = model.jyylmxmc2;
            parameters[150].Value = model.jyylmxgg2;
            parameters[151].Value = model.jyylmxsl2;
            parameters[152].Value = model.jyylmxyxq2;
            parameters[153].Value = model.jyylmxxh3;
            parameters[154].Value = model.jyylmxmc3;
            parameters[155].Value = model.jyylmxgg3;
            parameters[156].Value = model.jyylmxsl3;
            parameters[157].Value = model.jyylmxyxq3;
            parameters[158].Value = model.jyylmxxh4;
            parameters[159].Value = model.jyylmxmc4;
            parameters[160].Value = model.jyylmxgg4;
            parameters[161].Value = model.jyylmxsl4;
            parameters[162].Value = model.jyylmxyxq4;
            parameters[163].Value = model.jyylmxxh5;
            parameters[164].Value = model.jyylmxmc5;
            parameters[165].Value = model.jyylmxgg5;
            parameters[166].Value = model.jyylmxsl5;
            parameters[167].Value = model.jyylmxyxq5;
            parameters[168].Value = model.yjylnd1;
            parameters[169].Value = model.yjylggxh1;
            parameters[170].Value = model.yjylcl1;
            parameters[171].Value = model.yjylxssr1;
            parameters[172].Value = model.yjylbz1;
            parameters[173].Value = model.yjylnd2;
            parameters[174].Value = model.yjylggxh2;
            parameters[175].Value = model.yjylcl2;
            parameters[176].Value = model.yjylxssr2;
            parameters[177].Value = model.yjylbz2;
            parameters[178].Value = model.yjylnd3;
            parameters[179].Value = model.yjylggxh3;
            parameters[180].Value = model.yjylcl3;
            parameters[181].Value = model.yjylxssr3;
            parameters[182].Value = model.yjylbz3;
            parameters[183].Value = model.yjylnd4;
            parameters[184].Value = model.yjylggxh4;
            parameters[185].Value = model.yjylcl4;
            parameters[186].Value = model.yjylxssr4;
            parameters[187].Value = model.yjylbz4;
            parameters[188].Value = model.yjylnd5;
            parameters[189].Value = model.yjylggxh5;
            parameters[190].Value = model.yjylcl5;
            parameters[191].Value = model.yjylxssr5;
            parameters[192].Value = model.yjylbz5;
        ...
        public bool Update(basket_made model)
        {
            ...
            strSql.Append("jsfzrxm=@jsfzrxm,");
            strSql.Append("jsfzrxb=@jsfzrxb,");
            strSql.Append("jsfzrzgxl=@jsfzrzgxl,");
            strSql.Append("jsfzrzw=@jsfzrzw,");
            strSql.Append("jsfzrzc=@jsfzrzc,");
            strSql.Append("jsfzrzy=@jsfzrzy,");
            strSql.Append("jsfzrgddh=@jsfzrgddh,");
            strSql.Append("jsfzryddh=@jsfzryddh,");
            strSql.Append("jsfzrzypx=@jsfzrzypx,");
            strSql.Append("jsfzrpxsj=@jsfzrpxsj,");
            strSql.Append("jsfzrzsbh=@jsfzrzsbh,");
            ...
            parameters[18].Value = model.qyjj;
            ...
            parameters[30].Value = model.jsfzrxm;
            parameters[31].Value = model.jsfzrxb;
            parameters[32].Value = model.jsfzrzgxl;
            parameters[33].Value = model.jsfzrzw;
            parameters[34].Value = model.jsfzrzc;
            parameters[35].Value = model.jsfzrzy;
            parameters[36].Value = model.jsfzrgddh;
            parameters[37].Value = model.jsfzryddh;
            parameters[38].Value = model.jsfzrzypx;
            parameters[39].Value = model.jsfzrpxsj;
            parameters[40].Value = model.jsfzrzsbh;
            parameters[41].Value = model.zlfzrxm;
            parameters[42].Value = model.zlfzrxb;
            parameters[43].Value = model.zlfzrzgxl;
            parameters[44].Value = model.zlfzrzw;
            parameters[45].Value = model.zlfzrzc;
            parameters[46].Value = model.zlfzrzy;
            parameters[47].Value = model.zlfzrgddh;
            parameters[48].Value = model.zlfzryddh;
            parameters[49].Value = model.zlfzrzypx;
            parameters[50].Value = model.zlfzrpxsj;
            parameters[51].Value = model.zlfzrzsbh;
            parameters[52].Value = model.gzryxh1;
            parameters[53].Value = model.gzryxm1;
            parameters[54].Value = model.gzryzw1;
            parameters[55].Value = model.gzryzc1;
            parameters[56].Value = model.gzryfzjg1;
            parameters[57].Value = model.gzryxl1;
            parameters[58].Value = model.gzryzy1;
            parameters[59].Value = model.gzryxh2;
            parameters[60].Value = model.gzryxm2;
            parameters[61].Value = model.gzryzw2;
            parameters[62].Value = model.gzryzc2;
            parameters[63].Value = model.gzryfzjg2;
            parameters[64].Value = model.gzryxl2;
            parameters[65].Value = model.gzryzy2;
            parameters[66].Value = model.gzryxh3;
            parameters[67].Value = model.gzryxm3;
            parameters[68].Value = model.gzryzw3;
            parameters[69].Value = model.gzryzc3;
            parameters[70].Value = model.gzryfzjg3;
            parameters[71].Value = model.gzryxl3;
            parameters[72].Value = model.gzryzy3;
            parameters[73].Value = model.gzryxh4;
            parameters[74].Value = model.gzryxm4;
            parameters[75].Value = model.gzryzw4;
            parameters[76].Value = model.gzryzc4;
            parameters[77].Value = model.gzryfzjg4;
            parameters[78].Value = model.gzryxl4;
            parameters[79].Value = model.gzryzy4;
            parameters[80].Value = model.gzryxh5;
            parameters[81].Value = model.gzryxm5;
            parameters[82].Value = model.gzryzw5;
            parameters[83].Value = model.gzryzc5;
            parameters[84].Value = model.gzryfzjg5;
            parameters[85].Value = model.gzryxl5;
            parameters[86].Value = model.gzryzy5;
            parameters[87].Value = model.tzzyryxh1;
            parameters[88].Value = model.tzzyryxm1;
            parameters[89].Value = model.tzzyrygz1;
            parameters[90].Value = model.tzzyryxh2;
            parameters[91].Value = model.tzzyryxm2;
            parameters[92].Value = model.tzzyrygz2;
            parameters[93].Value = model.tzzyryxh3;
            parameters[94].Value = model.tzzyryxm3;
            parameters[95].Value = model.tzzyrygz3;
            parameters[96].Value = model.tzzyryxh4;
            parameters[97].Value = model.tzzyryxm4;
            parameters[98].Value = model.tzzyrygz4;
            parameters[99].Value = model.tzzyryxh5;
            parameters[100].Value = model.tzzyryxm5;
            parameters[101].Value = model.tzzyrygz5;
            parameters[102].Value = model.zgzsfzjg1;
            parameters[103].Value = model.zgzszsbh1;
            parameters[104].Value = model.zgzsyxq1;
            parameters[105].Value = model.zgzsfzjg2;
            parameters[106].Value = model.zgzszsbh2;
            parameters[107].Value = model.zgzsyxq2;
            parameters[108].Value = model.zgzsfzjg3;
            parameters[109].Value = model.zgzszsbh3;
            parameters[110].Value = model.zgzsyxq3;
            parameters[111].Value = model.zgzsfzjg4;
            parameters[112].Value = model.zgzszsbh4;
            parameters[113].Value = model.zgzsyxq4;
            parameters[114].Value = model.zgzsfzjg5;
            parameters[115].Value = model.zgzszsbh5;
            parameters[116].Value = model.zgzsyxq5;
            parameters[117].Value = model.mxxh1;
            parameters[118].Value = model.mxsbmc1;
            parameters[119].Value = model.mxgg1;
            parameters[120].Value = model.mxsl1;
            parameters[121].Value = model.mxzzs1;
            parameters[122].Value = model.mxxh2;
            parameters[123].Value = model.mxsbmc2;
            parameters[124].Value = model.mxgg2;
            parameters[125].Value = model.mxsl2;
            parameters[126].Value = model.mxzzs2;
            parameters[127].Value = model.mxxh3;
            parameters[128].Value = model.mxsbmc3;
            parameters[129].Value = model.mxgg3;
            parameters[130].Value = model.mxsl3;
            parameters[131].Value = model.mxzzs3;
            parameters[132].Value = model.mxxh4;
            parameters[133].Value = model.mxsbmc4;
            parameters[134].Value = model.mxgg4;
            parameters[135].Value = model.mxsl4;
            parameters[136].Value = model.mxzzs4;
            parameters[137].Value = model.mxxh5;
            parameters[138].Value = model.mxsbmc5;
            parameters[139].Value = model.mxgg5;
            parameters[140].Value = model.mxsl5;
            parameters[141].Value = model.mxzzs5;
            parameters[142].Value = model.jyylmxxh1;
            parameters[143].Value = model.jyylmxmc1;
            parameters[144].Value = model.jyylmxgg1;
            parameters[145].Value = model.jyylmxsl1;
            parameters[146].Value = model.jyylmxyxq1;
            parameters[147].Value = model.jyylmxxh2;
            parameters[148].Value = model.jyylmxmc2;
            parameters[149].Value = model.jyylmxgg2;
            parameters[150].Value = model.jyylmxsl2;
            parameters[151].Value = model.jyylmxyxq2;
            parameters[152].Value = model.jyylmxxh3;
            parameters[153].Value = model.jyylmxmc3;
            parameters[154].Value = model.jyylmxgg3;
            parameters[155].Value = model.jyylmxsl3;
            parameters[156].Value = model.jyylmxyxq3;
            parameters[157].Value = model.jyylmxxh4;
            parameters[158].Value = model.jyylmxmc4;
            parameters[159].Value = model.jyylmxgg4;
            parameters[160].Value = model.jyylmxsl4;
            parameters[161].Value = model.jyylmxyxq4;
            parameters[162].Value = model.jyylmxxh5;
            parameters[163].Value = model.jyylmxmc5;
            parameters[164].Value = model.jyylmxgg5;
            parameters[165].Value = model.jyylmxsl5;
            parameters[166].Value = model.jyylmxyxq5;
            parameters[167].Value = model.yjylnd1;
            parameters[168].Value = model.yjylggxh1;
            parameters[169].Value = model.yjylcl1;
            parameters[170].Value = model.yjylxssr1;
            parameters[171].Value = model.yjylbz1;
            parameters[172].Value = model.yjylnd2;
            parameters[173].Value = model.yjylggxh2;
            parameters[174].Value = model.yjylcl2;
            parameters[175].Value = model.yjylxssr2;
            parameters[176].Value = model.yjylbz2;
            parameters[177].Value = model.yjylnd3;
            parameters[178].Value = model.yjylggxh3;
            parameters[179].Value = model.yjylcl3;
            parameters[180].Value = model.yjylxssr3;
            parameters[181].Value = model.yjylbz3;
            parameters[182].Value = model.yjylnd4;
            parameters[183].Value = model.yjylggxh4;
            parameters[184].Value = model.yjylcl4;
            parameters[185].Value = model.yjylxssr4;
            parameters[186].Value = model.yjylbz4;
            parameters[187].Value = model.yjylnd5;
            parameters[188].Value = model.yjylggxh5;
            parameters[189].Value = model.yjylcl5;
            parameters[190].Value = model.yjylxssr5;
            parameters[191].Value = model.yjylbz5;
            parameters[192].Value = model.Guid;
        ...
        public basket_made DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["jsfzrxm"] != null)
                {
                    model.jsfzrxm = row["jsfzrxm"].ToString();
                }
                if (row["jsfzrxb"] != null)
                {
                    model.jsfzrxb = row["jsfzrxb"].ToString();
                }
                if (row["jsfzrzgxl"] != null)
                {
                    model.jsfzrzgxl = row["jsfzrzgxl"].ToString();
                }
                if (row["jsfzrzw"] != null)
                {
                    model.jsfzrzw = row["jsfzrzw"].ToString();
                }
                if (row["jsfzrzc"] != null)
                {
                    model.jsfzrzc = row["jsfzrzc"].ToString();
                }
                if (row["jsfzrzy"] != null)
                {
                    model.jsfzrzy = row["jsfzrzy"].ToString();
                }
                if (row["jsfzrgddh"] != null)
                {
                    model.jsfzrgddh = row["jsfzrgddh"].ToString();
                }
                if (row["jsfzryddh"] != null)
                {
                    model.jsfzryddh = row["jsfzryddh"].ToString();
                }
                if (row["jsfzrzypx"] != null)
                {
                    model.jsfzrzypx = row["jsfzrzypx"].ToString();
                }
                if (row["jsfzrpxsj"] != null)
                {
                    model.jsfzrpxsj = row["jsfzrpxsj"].ToString();
                }
                if (row["jsfzrzsbh"] != null)
                {
                    model.jsfzrzsbh = row["jsfzrzsbh"].ToString();
                }
                if (row["zlfzrxm"] != null)
                {
                ...
                if (row.Table.Columns.Contains("gzryxh2") && row["gzryxh2"] != null)
                {
                    model.gzryxh2 = row["gzryxh2"].ToString();
                }
                if (row.Table.Columns.Contains("gzryxm2") && row["gzryxm2"] != null)
                {
                    model.gzryxm2 = row["gzryxm2"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzw2") && row["gzryzw2"] != null)
                {
                    model.gzryzw2 = row["gzryzw2"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzc2") && row["gzryzc2"] != null)
                {
                    model.gzryzc2 = row["gzryzc2"].ToString();
                }
                if (row.Table.Columns.Contains("gzryfzjg2") && row["gzryfzjg2"] != null)
                {
                    model.gzryfzjg2 = row["gzryfzjg2"].ToString();
                }
                if (row.Table.Columns.Contains("gzryxl2") && row["gzryxl2"] != null)
                {
                    model.gzryxl2 = row["gzryxl2"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzy2") && row["gzryzy2"] != null)
                {
                    model.gzryzy2 = row["gzryzy2"].ToString();
                }
                if (row.Table.Columns.Contains("gzryxh3") && row["gzryxh3"] != null)
                {
                    model.gzryxh3 = row["gzryxh3"].ToString();
                }
                if (row.Table.Columns.Contains("gzryxm3") && row["gzryxm3"] != null)
                {
                    model.gzryxm3 = row["gzryxm3"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzw3") && row["gzryzw3"] != null)
                {
                    model.gzryzw3 = row["gzryzw3"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzc3") && row["gzryzc3"] != null)
                {
                    model.gzryzc3 = row["gzryzc3"].ToString();
                }
                if (row.Table.Columns.Contains("gzryfzjg3") && row["gzryfzjg3"] != null)
                {
                    model.gzryfzjg3 = row["gzryfzjg3"].ToString();
                }
                if (row.Table.Columns.Contains("gzryxl3") && row["gzryxl3"] != null)
                {
                    model.gzryxl3 = row["gzryxl3"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzy3") && row["gzryzy3"] != null)
                {
                    model.gzryzy3 = row["gzryzy3"].ToString();
                }
                if (row.Table.Columns.Contains("gzryxh4") && row["gzryxh4"] != null)
                {
                    model.gzryxh4 = row["gzryxh4"].ToString();
                }
                if (row.Table.Columns.Contains("gzryxm4") && row["gzryxm4"] != null)
                {
                    model.gzryxm4 = row["gzryxm4"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzw4") && row["gzryzw4"] != null)
                {
                    model.gzryzw4 = row["gzryzw4"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzc4") && row["gzryzc4"] != null)
                {
                    model.gzryzc4 = row["gzryzc4"].ToString();
                }
                if (row.Table.Columns.Contains("gzryfzjg4") && row["gzryfzjg4"] != null)
                {
                    model.gzryfzjg4 = row["gzryfzjg4"].ToString();
                }
                if (row.Table.Columns.Contains("gzryxl4") && row["gzryxl4"] != null)
                {
                    model.gzryxl4 = row["gzryxl4"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzy4") && row["gzryzy4"] != null)
                {
                    model.gzryzy4 = row["gzryzy4"].ToString();
                }
                if (row.Table.Columns.Contains("gzryxh5") && row["gzryxh5"] != null)
                {
                    model.gzryxh5 = row["gzryxh5"].ToString();
                }
                if (row.Table.Columns.Contains("gzryxm5") && row["gzryxm5"] != null)
                {
                    model.gzryxm5 = row["gzryxm5"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzw5") && row["gzryzw5"] != null)
                {
                    model.gzryzw5 = row["gzryzw5"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzc5") && row["gzryzc5"] != null)
                {
                    model.gzryzc5 = row["gzryzc5"].ToString();
                }
                if (row.Table.Columns.Contains("gzryfzjg5") && row["gzryfzjg5"] != null)
                {
                    model.gzryfzjg5 = row["gzryfzjg5"].ToString();
                }
                if (row.Table.Columns.Contains("gzryxl5") && row["gzryxl5"] != null)
                {
                    model.gzryxl5 = row["gzryxl5"].ToString();
                }
                if (row.Table.Columns.Contains("gzryzy5") && row["gzryzy5"] != null)
                {
                ...
                if (row.Table.Columns.Contains("tzzyryxh2") && row["tzzyryxh2"] != null)
                {
                    model.tzzyryxh2 = row["tzzyryxh2"].ToString();
                }
                if (row.Table.Columns.Contains("tzzyryxm2") && row["tzzyryxm2"] != null)
                {
                    model.tzzyryxm2 = row["tzzyryxm2"].ToString();
                }
                if (row.Table.Columns.Contains("tzzyrygz2") && row["tzzyrygz2"] != null)
                {
                    model.tzzyrygz2 = row["tzzyrygz2"].ToString();
                }
                if (row.Table.Columns.Contains("tzzyryxh3") && row["tzzyryxh3"] != null)
                {
                    model.tzzyryxh3 = row["tzzyryxh3"].ToString();
                }
                if (row.Table.Columns.Contains("tzzyryxm3") && row["tzzyryxm3"] != null)
                {
                    model.tzzyryxm3 = row["tzzyryxm3"].ToString();
                }
                if (row.Table.Columns.Contains("tzzyrygz3") && row["tzzyrygz3"] != null)
                {
                    model.tzzyrygz3 = row["tzzyrygz3"].ToString();
                }
                if (row.Table.Columns.Contains("tzzyryxh4") && row["tzzyryxh4"] != null)
                {
                    model.tzzyryxh4 = row["tzzyryxh4"].ToString();
                }
                if (row.Table.Columns.Contains("tzzyryxm4") && row["tzzyryxm4"] != null)
                {
                    model.tzzyryxm4 = row["tzzyryxm4"].ToString();
                }
                if (row.Table.Columns.Contains("tzzyrygz4") && row["tzzyrygz4"] != null)
                {
                    model.tzzyrygz4 = row["tzzyrygz4"].ToString();
                }
                if (row.Table.Columns.Contains("tzzyryxh5") && row["tzzyryxh5"] != null)
                {
                    model.tzzyryxh5 = row["tzzyryxh5"].ToString();
                }
                if (row.Table.Columns.Contains("tzzyryxm5") && row["tzzyryxm5"] != null)
                {
                    model.tzzyryxm5 = row["tzzyryxm5"].ToString();
                }
                if (row.Table.Columns.Contains("tzzyrygz5") && row["tzzyrygz5"] != null)
                {
                ...
                if (row.Table.Columns.Contains("mxxh2") && row["mxxh2"] != null)
                {
                    model.mxxh2 = row["mxxh2"].ToString();
                }
                if (row.Table.Columns.Contains("mxsbmc2") && row["mxsbmc2"] != null)
                {
                    model.mxsbmc2 = row["mxsbmc2"].ToString();
                }
                if (row.Table.Columns.Contains("mxgg2") && row["mxgg2"] != null)
                {
                    model.mxgg2 = row["mxgg2"].ToString();
                }
                if (row.Table.Columns.Contains("mxsl2") && row["mxsl2"] != null)
                {
                    model.mxsl2 = row["mxsl2"].ToString();
                }
                if (row.Table.Columns.Contains("mxzzs2") && row["mxzzs2"] != null)
                {
                    model.mxzzs2 = row["mxzzs2"].ToString();
                }
                if (row.Table.Columns.Contains("mxxh3") && row["mxxh3"] != null)
                {
                    model.mxxh3 = row["mxxh3"].ToString();
                }
                if (row.Table.Columns.Contains("mxsbmc3") && row["mxsbmc3"] != null)
                {
                    model.mxsbmc3 = row["mxsbmc3"].ToString();
                }
                if (row.Table.Columns.Contains("mxgg3") && row["mxgg3"] != null)
                {
                    model.mxgg3 = row["mxgg3"].ToString();
                }
                if (row.Table.Columns.Contains("mxsl3") && row["mxsl3"] != null)
                {
                    model.mxsl3 = row["mxsl3"].ToString();
                }
                if (row.Table.Columns.Contains("mxzzs3") && row["mxzzs3"] != null)
                {
                    model.mxzzs3 = row["mxzzs3"].ToString();
                }
                if (row.Table.Columns.Contains("mxxh4") && row["mxxh4"] != null)
                {
                    model.mxxh4 = row["mxxh4"].ToString();
                }
                if (row.Table.Columns.Contains("mxsbmc4") && row["mxsbmc4"] != null)
                {
                    model.mxsbmc4 = row["mxsbmc4"].ToString();
                }
                if (row.Table.Columns.Contains("mxxh2") && row["mxgg4"] != null)
                {
                    model.mxgg4 = row["mxgg4"].ToString();
                }
                if (row.Table.Columns.Contains("mxsl4") && row["mxsl4"] != null)
                {
                    model.mxsl4 = row["mxsl4"].ToString();
                }
                if (row.Table.Columns.Contains("mxzzs4") && row["mxzzs4"] != null)
                {
                    model.mxzzs4 = row["mxzzs4"].ToString();
                }
                if (row.Table.Columns.Contains("mxxh5") && row["mxxh5"] != null)
                {
                    model.mxxh5 = row["mxxh5"].ToString();
                }
                if (row.Table.Columns.Contains("mxsbmc5") && row["mxsbmc5"] != null)
                {
                    model.mxsbmc5 = row["mxsbmc5"].ToString();
                }
                if (row.Table.Columns.Contains("mxgg5") && row["mxgg5"] != null)
                {
                    model.mxgg5 = row["mxgg5"].ToString();
                }
                if (row.Table.Columns.Contains("mxsl5") && row["mxsl5"] != null)
                {
                    model.mxsl5 = row["mxsl5"].ToString();
                }
                if (row.Table.Columns.Contains("mxzzs5") && row["mxzzs5"] != null)
                {
                ...
                if (row.Table.Columns.Contains("jyylmxxh2") && row["jyylmxxh2"] != null)
                {
                    model.jyylmxxh2 = row["jyylmxxh2"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxmc2") && row["jyylmxmc2"] != null)
                {
                    model.jyylmxmc2 = row["jyylmxmc2"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxgg2") && row["jyylmxgg2"] != null)
                {
                    model.jyylmxgg2 = row["jyylmxgg2"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxsl2") && row["jyylmxsl2"] != null)
                {
                    model.jyylmxsl2 = row["jyylmxsl2"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxyxq2") && row["jyylmxyxq2"] != null)
                {
                    model.jyylmxyxq2 = row["jyylmxyxq2"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxxh3") && row["jyylmxxh3"] != null)
                {
                    model.jyylmxxh3 = row["jyylmxxh3"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxmc3") && row["jyylmxmc3"] != null)
                {
                    model.jyylmxmc3 = row["jyylmxmc3"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxgg3") && row["jyylmxgg3"] != null)
                {
                    model.jyylmxgg3 = row["jyylmxgg3"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxsl3") && row["jyylmxsl3"] != null)
                {
                    model.jyylmxsl3 = row["jyylmxsl3"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxyxq3") && row["jyylmxyxq3"] != null)
                {
                    model.jyylmxyxq3 = row["jyylmxyxq3"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxxh4") && row["jyylmxxh4"] != null)
                {
                    model.jyylmxxh4 = row["jyylmxxh4"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxmc4") && row["jyylmxmc4"] != null)
                {
                    model.jyylmxmc4 = row["jyylmxmc4"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxgg4") && row["jyylmxgg4"] != null)
                {
                    model.jyylmxgg4 = row["jyylmxgg4"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxsl4") && row["jyylmxsl4"] != null)
                {
                    model.jyylmxsl4 = row["jyylmxsl4"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxyxq4") && row["jyylmxyxq4"] != null)
                {
                    model.jyylmxyxq4 = row["jyylmxyxq4"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxxh5") && row["jyylmxxh5"] != null)
                {
                    model.jyylmxxh5 = row["jyylmxxh5"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxmc5") && row["jyylmxmc5"] != null)
                {
                    model.jyylmxmc5 = row["jyylmxmc5"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxgg5") && row["jyylmxgg5"] != null)
                {
                    model.jyylmxgg5 = row["jyylmxgg5"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxsl5") && row["jyylmxsl5"] != null)
                {
                    model.jyylmxsl5 = row["jyylmxsl5"].ToString();
                }
                if (row.Table.Columns.Contains("jyylmxyxq5") && row["jyylmxyxq5"] != null)
                {
                ...
                if (row.Table.Columns.Contains("yjylnd2") && row["yjylnd2"] != null)
                {
                    model.yjylnd2 = row["yjylnd2"].ToString();
                }
                if (row.Table.Columns.Contains("yjylggxh2") && row["yjylggxh2"] != null)
                {
                    model.yjylggxh2 = row["yjylggxh2"].ToString();
                }
                if (row.Table.Columns.Contains("yjylcl2") && row["yjylcl2"] != null)
                {
                    model.yjylcl2 = row["yjylcl2"].ToString();
                }
                if (row.Table.Columns.Contains("yjylxssr2") && row["yjylxssr2"] != null)
                {
                    model.yjylxssr2 = row["yjylxssr2"].ToString();
                }
                if (row.Table.Columns.Contains("yjylbz2") && row["yjylbz2"] != null)
                {
                    model.yjylbz2 = row["yjylbz2"].ToString();
                }
                if (row.Table.Columns.Contains("yjylnd3") && row["yjylnd3"] != null)
                {
                    model.yjylnd3 = row["yjylnd3"].ToString();
                }
                if (row.Table.Columns.Contains("yjylggxh3") && row["yjylggxh3"] != null)
                {
                    model.yjylggxh3 = row["yjylggxh3"].ToString();
                }
                if (row.Table.Columns.Contains("yjylcl3") && row["yjylcl3"] != null)
                {
                    model.yjylcl3 = row["yjylcl3"].ToString();
                }
                if (row.Table.Columns.Contains("yjylxssr3") && row["yjylxssr3"] != null)
                {
                    model.yjylxssr3 = row["yjylxssr3"].ToString();
                }
                if (row.Table.Columns.Contains("yjylbz3") && row["yjylbz3"] != null)
                {
                    model.yjylbz3 = row["yjylbz3"].ToString();
                }
                if (row.Table.Columns.Contains("yjylnd4") && row["yjylnd4"] != null)
                {
                    model.yjylnd4 = row["yjylnd4"].ToString();
                }
                if (row.Table.Columns.Contains("yjylggxh4") && row["yjylggxh4"] != null)
                {
                    model.yjylggxh4 = row["yjylggxh4"].ToString();
                }
                if (row.Table.Columns.Contains("yjylcl4") && row["yjylcl4"] != null)
                {
                    model.yjylcl4 = row["yjylcl4"].ToString();
                }
                if (row.Table.Columns.Contains("yjylxssr4") && row["yjylxssr4"] != null)
                {
                    model.yjylxssr4 = row["yjylxssr4"].ToString();
                }
                if (row.Table.Columns.Contains("yjylbz4") && row["yjylbz4"] != null)
                {
                    model.yjylbz4 = row["yjylbz4"].ToString();
                }
                if (row.Table.Columns.Contains("yjylnd5") && row["yjylnd5"] != null)
                {
                    model.yjylnd5 = row["yjylnd5"].ToString();
                }
                if (row.Table.Columns.Contains("yjylggxh5") && row["yjylggxh5"] != null)
                {
                    model.yjylggxh5 = row["yjylggxh5"].ToString();
                }
                if (row.Table.Columns.Contains("yjylcl5") && row["yjylcl5"] != null)
                {
                    model.yjylcl5 = row["yjylcl5"].ToString();
                }
                if (row.Table.Columns.Contains("yjylxssr5") && row["yjylxssr5"] != null)
                {
                    model.yjylxssr5 = row["yjylxssr5"].ToString();
                }
                if (row.Table.Columns.Contains("yjylbz5") && row["yjylbz5"] != null)
                {
