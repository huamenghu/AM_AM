...
namespace AM.BLL
{
	...
	public partial class basket_madeBLL
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public AM.Model.basket_made GetModelByCache(string Guid)
		{
			...
			return (AM.Model.basket_made)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<AM.Model.basket_made> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<AM.Model.basket_made> DataTableToList(DataTable dt)
		{
			List<AM.Model.basket_made> modelList = new List<AM.Model.basket_made>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				AM.Model.basket_made model;
